...
public class NodeAlgSignRun extends Thread {
	...
	static void getNodes1(String filename1, String type, Set<String> statements1,Map<String,Node> statements_map1)
	{
	...
	static void getNodes2(String filename2, String type,Set<String> statements2,Map<String,Node> statements_map2)
	{
	...
	static public void test(String filename1,String filename2, String type) {
		...
		getNodes1(filename1, type, statements1,statements_map1);
		System.gc();
		getNodes2(filename2, type, statements2,statements_map2);
		System.gc();
