...
public class IFC_CompareDRUM {

    ExpressReader er;

    public IFC_CompareDRUM(String express_file,int changed_line,String file1,String file2) {

	er = new ExpressReader(express_file);
	DiffResult msg_grounding_result=null;
	DiffResult msg_wogrounding_result=null;
	try
	{
	  msg_grounding_result=diffMSGGrounding(file1,file2);
	  msg_wogrounding_result=diffMSGWOGrounding(file1,file2);
	}
	catch (Exception e) {
	    return;  // broken file
	}
    ...
    public static void main(String[] args) {
        new IFC_CompareDRUM("c:\\jo\\IFC2X3_TC1.exp",1,"c:\\export\\drum_10_A.ifc","c:\\export\\drum_10_A.ifc");
