...
public class JenaStatisticsBasicGroundingSeparatesUNIX {
    ...
    public JenaStatisticsBasicGroundingSeparatesUNIX(String filename) {
    ...
    {
	new JenaStatisticsBasicGroundingSeparatesUNIX(file);
    }

    public static void main(String[] args) {
      JenaStatisticsBasicGroundingSeparatesUNIX.rdf_filename=args[0]+".tulos_sep.ttl";
      JenaStatisticsBasicGroundingSeparatesUNIX.run(args[0]);
