...
public class JenaFindLargestNeighborhoodOfMSGMAX {

    private Model drum_statistics_model;
    Resource test_file;
    static String ns = "http://drum/diff#";
    static String test_uri="test/crossing_paths";
    Property msg_max_node_of_largest_neighborhood;

    Property statistics_nodes;
    Property statistics_nodes_in_maxmsg;

    static String rdf_filename="c:\\jo/DRUM/statistics_msg_max_node_of_largest_neighborhood.ttl";
	...
	msg_max_node_of_largest_neighborhood = drum_statistics_model.createProperty( ns + "msg_max_node_of_largest_neighborhood_not_yet_grounded" );
	statistics_nodes = drum_statistics_model.createProperty( ns + "nodes" );
	statistics_nodes_in_maxmsg = drum_statistics_model.createProperty( ns + "nodes_in_maxmsg" );
    }
    ...
    public JenaFindLargestNeighborhoodOfMSGMAX(String filename) {
   ...
   public void runStatistics(String filename) {
	...
	//drum_statistics_model.add(test_file,statistics_nodes,nodes.size()+"");


	largestneighborhood(model.msgs.get(maxi));
   ...
   public void largestneighborhood(List<Triple> triples)
   {
	Map<Thing,List<Link>> links=new HashMap<Thing,List<Link>>();
	Set<Thing> enodes=new HashSet<Thing>();
	Set<Object> nodes=new HashSet<Object>();
	for(int i=0;i<triples.size();i++)
	{
	    ...
	    if(!t.literal)
	    {
	      ...
	      connections_o.add(l);
	      enodes.add(t.s);
	      enodes.add((Thing)t.o);
	    }
	}
	SortedMap<Integer,Thing> sorted=new TreeMap<Integer,Thing>();
	
	Iterator it=enodes.iterator();
	while(it.hasNext())
	{
	    Thing t=(Thing)it.next();
	    if(t.is_grounded)
		continue;
	    Set<Thing> neighborhood=new HashSet<Thing>();

	    Thing current0=t;
	    List<Link> ls1=links.get(current0);
	    for(int n0=0;n0<ls1.size();n0++)
	    {
		Link l1=ls1.get(n0);
		Thing current1=l1.getTheOtherEnd(current0);
		neighborhood.add(current1);
		List<Link> ls2=links.get(current1);
		for(int n1=0;n1<ls2.size();n1++)
		{
			Link l2=ls2.get(n1);
			Thing current2=l2.getTheOtherEnd(current1);
			neighborhood.add(current2);
			
			List<Link> ls3=links.get(current2);
			for(int n2=0;n2<ls3.size();n2++)
			{
				Link l3=ls3.get(n2);
				Thing current3=l3.getTheOtherEnd(current2);
				neighborhood.add(current3);
			}

		}
	    }
           sorted.put(neighborhood.size(), t);
	}
        System.out.println(""+sorted.lastKey()+" "+sorted.get(sorted.lastKey()));
        Thing maxt=sorted.get(sorted.lastKey());
	drum_statistics_model.add(test_file,statistics_nodes_in_maxmsg,nodes.size()+"");

	//drum_statistics_model.add(test_file,msg_max_node_of_largest_neighborhood,maxt.line_number+"."+maxt.getClass().getSimpleName()+"_count:"+sorted.lastKey());
   }
	...
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\IFCtest_data\\drum_10.ifc");
    }

    public static void basic_testset() {	
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\IFCtest_data\\drum_10.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models\\DC_Riverside_Bldg-LOD_100.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\First_Floor_Vent.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\Second_Floor_Vent.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\Ground_Floor_Vent.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models\\2\\PART03_Buderus_200406_20070209_ifc.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models\\2\\PART02_Wilfer_200302_20070209_IFC.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\Crane.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models\\2\\PART06_Kermi_200405_20070401_IFC.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models\\2\\AC11-Institute-Var-2-IFC.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\AC11-Institute-Var-2-IFC.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models\\ADT-FZK-Haus-2005-2006.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\IFCtest_data\\talo_testi.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\AC-11-Smiley-West-04-07-2007.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\AC14-FZK-Haus.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models\\2\\Bien-Zenker_Jasmin-Sun-AC14-V2.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models\\2\\Allplan-2008-Institute-Var-2-IFC.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\Allplan-2008-Institute-Var-2-IFC.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\ARK_Helmisimpukka_20100919.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\OfficeBuilding.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\Smiley-West-5-Buildings-14-10-2005.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\RAK_Helmisimpukka_20111220.ifc");
    }
	...
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\Smiley-West-5-Buildings-14-10-2005.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\RAK_Helmisimpukka_20111220.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\DC_Riverside-STRUC-LOD_300.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models\\2\\FJK-Project-Final.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models\\HITOS_Electrical_Update_Storey_3_2006-10-11.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\HITOS_Electrical_Update_Storey_3_2006-10-11.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\SMC Building - modified.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\SMC Building.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\ARK_Helmisimpukka_20101209.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\Ettenheim-GIS-05-11-2006_optimized.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\ARK_Helmisimpukka_20110920.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models2\\DC_Riverside-LOD_300-HVAC.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models\\Planer 4B Full.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\models\\HiB_DuctWork.ifc");
	new JenaFindLargestNeighborhoodOfMSGMAX("C:\\jo\\IFCtest_data\\inp3.ifc");
    }


    public static void main(String[] args) {
       JenaFindLargestNeighborhoodOfMSGMAX.basic_testset();
    }
