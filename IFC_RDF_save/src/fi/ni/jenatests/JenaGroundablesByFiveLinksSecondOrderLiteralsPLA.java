...
public class JenaGroundablesByFiveLinksSecondOrderLiteralsPLA {
    
    private Model drum_statistics_model;
    Resource test_file;
    Resource test_results;
    static String ns = "http://drum/diff#";
    static String test_uri="test/t5_max_second_order_literalsPLA";
    ...
    static String rdf_filename="c:\\jo/DRUM/statistics_t5_max_second_order_literals.ttl";
	...
	drum_statistics_model.add(test,test_name,"grouded by 5 max in and out links, literals grounded + gs:(true, true, true, true, true, false, true) _second_order_literals, Presentation Layer Assignment");
    ...
    public JenaGroundablesByFiveLinksSecondOrderLiteralsPLA(String filename) {
	...
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\IFCtest_data\\drum_10.ifc");
    }

    public static void basic_testset() {	
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\IFCtest_data\\drum_10.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models\\DC_Riverside_Bldg-LOD_100.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\First_Floor_Vent.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\Second_Floor_Vent.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\Ground_Floor_Vent.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models\\2\\PART03_Buderus_200406_20070209_ifc.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models\\2\\PART02_Wilfer_200302_20070209_IFC.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\Crane.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models\\2\\PART06_Kermi_200405_20070401_IFC.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models\\2\\AC11-Institute-Var-2-IFC.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\AC11-Institute-Var-2-IFC.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models\\ADT-FZK-Haus-2005-2006.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\IFCtest_data\\talo_testi.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\AC-11-Smiley-West-04-07-2007.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\AC14-FZK-Haus.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models\\2\\Bien-Zenker_Jasmin-Sun-AC14-V2.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models\\2\\Allplan-2008-Institute-Var-2-IFC.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\Allplan-2008-Institute-Var-2-IFC.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\ARK_Helmisimpukka_20100919.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\OfficeBuilding.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\Smiley-West-5-Buildings-14-10-2005.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\RAK_Helmisimpukka_20111220.ifc");
    }
	...
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\Smiley-West-5-Buildings-14-10-2005.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\RAK_Helmisimpukka_20111220.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\DC_Riverside-STRUC-LOD_300.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models\\2\\FJK-Project-Final.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models\\HITOS_Electrical_Update_Storey_3_2006-10-11.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\HITOS_Electrical_Update_Storey_3_2006-10-11.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\SMC Building - modified.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\SMC Building.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\ARK_Helmisimpukka_20101209.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\Ettenheim-GIS-05-11-2006_optimized.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\ARK_Helmisimpukka_20110920.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models2\\DC_Riverside-LOD_300-HVAC.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models\\Planer 4B Full.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\models\\HiB_DuctWork.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsPLA("C:\\jo\\IFCtest_data\\inp3.ifc");
    }
	...
	/*
      ...
      JenaGroundablesByFiveLinksSecondOrderLiteralsPLA.set_test_properties();
      JenaGroundablesByFiveLinksSecondOrderLiteralsPLA.basic_testset();
    }
