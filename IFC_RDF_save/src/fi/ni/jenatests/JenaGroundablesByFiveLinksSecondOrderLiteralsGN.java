...
public class JenaGroundablesByFiveLinksSecondOrderLiteralsGN {
    ...
    static String rdf_filename="c:\\jo/DRUM/statistics_t5_max_second_order_literals_unique_global_naming.ttl";
    ...
    public JenaGroundablesByFiveLinksSecondOrderLiteralsGN(String filename) {
	...
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\IFCtest_data\\drum_10.ifc");
    }

    public static void basic_testset() {	
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\IFCtest_data\\drum_10.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models\\DC_Riverside_Bldg-LOD_100.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\First_Floor_Vent.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\Second_Floor_Vent.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\Ground_Floor_Vent.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models\\2\\PART03_Buderus_200406_20070209_ifc.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models\\2\\PART02_Wilfer_200302_20070209_IFC.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\Crane.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models\\2\\PART06_Kermi_200405_20070401_IFC.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models\\2\\AC11-Institute-Var-2-IFC.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\AC11-Institute-Var-2-IFC.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models\\ADT-FZK-Haus-2005-2006.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\IFCtest_data\\talo_testi.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\AC-11-Smiley-West-04-07-2007.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\AC14-FZK-Haus.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models\\2\\Bien-Zenker_Jasmin-Sun-AC14-V2.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models\\2\\Allplan-2008-Institute-Var-2-IFC.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\Allplan-2008-Institute-Var-2-IFC.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\ARK_Helmisimpukka_20100919.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\OfficeBuilding.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\Smiley-West-5-Buildings-14-10-2005.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\RAK_Helmisimpukka_20111220.ifc");
    }
	...
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\Smiley-West-5-Buildings-14-10-2005.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\RAK_Helmisimpukka_20111220.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\DC_Riverside-STRUC-LOD_300.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models\\2\\FJK-Project-Final.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models\\HITOS_Electrical_Update_Storey_3_2006-10-11.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\HITOS_Electrical_Update_Storey_3_2006-10-11.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\SMC Building - modified.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\SMC Building.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\ARK_Helmisimpukka_20101209.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\Ettenheim-GIS-05-11-2006_optimized.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\ARK_Helmisimpukka_20110920.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models2\\DC_Riverside-LOD_300-HVAC.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models\\Planer 4B Full.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\models\\HiB_DuctWork.ifc");
	new JenaGroundablesByFiveLinksSecondOrderLiteralsGN("C:\\jo\\IFCtest_data\\inp3.ifc");
    }
	...
	/*
      ...
      JenaGroundablesByFiveLinksSecondOrderLiteralsGN.set_test_properties();
      JenaGroundablesByFiveLinksSecondOrderLiteralsGN.basic_testset();
    }
