...
public class LargestNeighborhoodMaxMsg {
    ...
    public LargestNeighborhoodMaxMsg(String filename) {
   ...
   public void runStatistics(String filename) {
	...
	largestNeigborhood(model.msgs.get(maxi));

   }

    public void largestNeigborhood(List<Triple> triples)
    {
	...
	while(it.hasNext())
	{
	    ...
	    Set<Thing> neigborhood=new HashSet<Thing>();
		...
		for(int n1=0;n1<ls2.size();n1++)
		{
			...
			for(int n2=0;n2<ls3.size();n2++)
			{
				...
				neigborhood.add(current3);
			}

		}
	    }
            sorted.put(neigborhood.size(), t);
	}
         System.out.println(""+sorted.lastKey()+" "+sorted.get(sorted.lastKey()));
    }

    public static void tiny_testset() {	
	new LargestNeighborhoodMaxMsg("C:\\jo\\IFCtest_data\\drum_10.ifc");
    }

    public static void basic_testset() {	
	new LargestNeighborhoodMaxMsg("C:\\jo\\IFCtest_data\\drum_10.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models\\DC_Riverside_Bldg-LOD_100.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\First_Floor_Vent.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\Second_Floor_Vent.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\Ground_Floor_Vent.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models\\2\\PART03_Buderus_200406_20070209_ifc.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models\\2\\PART02_Wilfer_200302_20070209_IFC.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\Crane.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models\\2\\PART06_Kermi_200405_20070401_IFC.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models\\2\\AC11-Institute-Var-2-IFC.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\AC11-Institute-Var-2-IFC.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models\\ADT-FZK-Haus-2005-2006.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\IFCtest_data\\talo_testi.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\AC-11-Smiley-West-04-07-2007.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\AC14-FZK-Haus.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models\\2\\Bien-Zenker_Jasmin-Sun-AC14-V2.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models\\2\\Allplan-2008-Institute-Var-2-IFC.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\Allplan-2008-Institute-Var-2-IFC.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\ARK_Helmisimpukka_20100919.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\OfficeBuilding.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\Smiley-West-5-Buildings-14-10-2005.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\RAK_Helmisimpukka_20111220.ifc");
    }
	...
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\Smiley-West-5-Buildings-14-10-2005.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\RAK_Helmisimpukka_20111220.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\DC_Riverside-STRUC-LOD_300.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models\\2\\FJK-Project-Final.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models\\HITOS_Electrical_Update_Storey_3_2006-10-11.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\HITOS_Electrical_Update_Storey_3_2006-10-11.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\SMC Building - modified.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\SMC Building.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\ARK_Helmisimpukka_20101209.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\Ettenheim-GIS-05-11-2006_optimized.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\ARK_Helmisimpukka_20110920.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models2\\DC_Riverside-LOD_300-HVAC.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models\\Planer 4B Full.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\models\\HiB_DuctWork.ifc");
	new LargestNeighborhoodMaxMsg("C:\\jo\\IFCtest_data\\inp3.ifc");
    }
    ...
    public static void main(String[] args) {
       LargestNeighborhoodMaxMsg.tiny_testset();
    }
