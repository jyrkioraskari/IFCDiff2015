...
public class StringChecksum {
    ...
    {
	StringChecksum md5=new StringChecksum(this.old);
	return md5;
    }
	...
	if (value_read)
	{
	    System.err.println("String Md5: Path checksum out of sequence!:"+txt);
	...
	{
		StringChecksum md5_1 = new StringChecksum();
		md5_1.update(n+"");
	...
	md5_1.update("A");
	md5_1.update("B");
	System.out.println(md5_1.getChecksumValue());


	StringChecksum md5_11 = md5_1.copy();
	md5_11.update("B");
	md5_11.update("A");
	System.out.println(md5_11.getChecksumValue());

	StringChecksum md5_12 = md5_1.copy();
	md5_12.update("B");
	md5_12.update("A");
